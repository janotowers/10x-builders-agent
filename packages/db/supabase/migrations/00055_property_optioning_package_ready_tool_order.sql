-- ============================================================
-- 00055_property_optioning_package_ready_tool_order.sql
--
-- Reordena skill_tools de package_ready para alinear readiness UI
-- con el workflow del skill publish-listing-package:
--   análisis → entorno → borrador → HITL (notify) → watermark → publicar
-- ============================================================
