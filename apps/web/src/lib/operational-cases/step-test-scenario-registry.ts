  ...
  property_optioning: {
    ...
    comparables_in_progress: [
      ...
      },
      {
        ...
        message:
          "Prueba controlada de paso (N4) para comparables_in_progress — escenario datos insuficientes. Actúa como property-optioning-coach. El property_data sembrado usa ~8 m² a propósito (filtros muy estrechos). Consulta las tres fuentes (EasyBroker activas, EasyBroker cerradas, BigQuery interno). Si tras normalizar la suma de comparables USABLES es 0 en todas las fuentes: NO avances a price_proposal_pending; deja current_step=comparables_in_progress y status=waiting_internal; persiste comparables_analysis con filters_used, data_quality.warnings y usable_count=0; ejecuta notify_user al asesor con datos de la propiedad, filtros usados y sugerencias concretas para ampliar búsqueda. No uses telegram_send_message_to_contact.",
      },
    ],
